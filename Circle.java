/**
	*This class implements the DrawingObject interface. It accepts the values to be used as the coordinates, size and color of the circle shape.
	*
...
public class Circle implements DrawingObject
{
	...
	//The constructor accepts 5 values. These represent the color, coordinates and size of the circle to be drawn.
	...
	//This method draws the circle using the assigned values. It makes use of the Ellipse2D.Double class.
